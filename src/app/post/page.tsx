        ...
        <main className={'bg-neutral-900'}>
            <div className={'px-[20px] md:px-[40px] xl:px-[80px] max-w-[1920px] mx-auto'}>
                <form onSubmit={handleSubmit(onSubmit)} className={'flex flex-col gap-[20px] text-white mx-auto p-[35px] pt-[45px] bg-neutral-800 rounded-[10px]'}>
                    ...
                    <TextArea {...register("title")} className={'w-full'} nameField={'Title:'}></TextArea>
                    <TextArea {...register("body")} className={'min-h-[200px] w-full'} nameField={'Body:'}></TextArea>
                    ...
                    <GreenMatteButton type={'submit'} className={'mt-[20px] w-[200px] !py-[15px] mx-auto bg-neutral-950'}>Create</GreenMatteButton>
                </form>
            </div>
        </main>
    );
